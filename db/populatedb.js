...
CREATE TABLE IF NOT EXISTS developers (
  ...
  CONSTRAINT unique_dev_name UNIQUE (first_name, last_name) -- Added Composite Unique
);
...
VALUES 
('FFXIV', 'https://cdn11.bigcommerce.com/s-6rs11v9w2d/images/stencil/270x360/products/3100/16721/FFXIV_DT_Agnostic_Packshot_Standard_Edition_1000x1436_EN_v1__39320.1711384448.jpg'),
('World of Warcraft', 'https://i.ebayimg.com/00/s/MTYwMFgxMDY2/z/iVAAAOSwP0JdcVlR/$_57.JPG?set_id=8800005007'),
...
VALUES ('MMORPG'), ('Adventure'), ('Fantasy'), ('Online'), ('Sandbox'), ('Platformer')
ON CONFLICT (title) DO NOTHING;

INSERT INTO developers (first_name, last_name)
VALUES
('Naoki', 'Yoshida'), ('Jeff', 'Kaplan'), ('Casey', 'Hunt'), ('Markus', 'Persson'), ('Swen', 'Vincke')
ON CONFLICT (first_name, last_name) DO NOTHING;

INSERT INTO game_genres (game_id, genre_id) VALUES
(1, 1), (1, 3), (1, 4), (2, 1), (2, 3), (2, 4), (3, 2), (3, 6), (4, 5), (4, 2), (5, 2), (5, 3)
